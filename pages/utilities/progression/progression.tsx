        ...
        <Layout title="Progression Generator" user={user}>
            <div className={styles.container}>
                ...
                <div className={styles.buttonRow}>
                    <button className="btn btn-danger-outlined" onClick={handleClear}>
                        Clear
                    </button>
                    <CopyToClipboardButton sourceRef={textarea} setAlertOptions={setAlertOptions} />
                    <button className="btn btn-primary" onClick={handleGenerateProg}>
                        Generate
                    </button>
                </div>
