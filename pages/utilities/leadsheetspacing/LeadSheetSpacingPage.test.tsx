...
import LeadSheetSpacingPage from './LeadSheetSpacingPage';
...
function renderLeadSheetSpacing() {
    ...
    const utils = render(<LeadSheetSpacingPage {...defaultProps} />);
    ...
    const clearResultButton = screen.getByRole('button', {
        name: /clear result/i,
    });
    const addHyphenCheckbox = screen.getByRole('checkbox', {
        name: /add hyphen between syllables.*/i,
    });
    const removeStringsCheckbox = screen.getByRole('checkbox', {
        name: /remove selected strings.*/i,
    });
    const addStringTextbox = screen.getByRole('textbox', {
        name: /add string to remove.*/i,
    });
    const addStringButton = screen.getByRole('button', { name: /add/i });
    const togglePlaceholderButton = screen.getByRole('button', {
        name: /toggle placeholder/i,
    });
    return {
        ...utils,
        inputTextArea,
